        ...
        <div class="grid">
            <div class="painel">
                <div class="painel-header">
                    ...
                    <a href="#" class="btn btn-green">table Categorys</a>
                </div>
                <div class="painel-body">
                    <div class="alert alert-success">
                        <div class="alert alert-success">
                            <a href="./Categorys/Create.php" class="btn btn-blue">
                                    ...
                                    if ($result = $con->query($sql)) {
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_array()) {
                                                ...
                                                //     </td>";
                                                echo " <td><a href='./Comment/Update.php?id=" . $row['id'] . "' class='btn btn-orange'><i class='fa fa-edit' aria-hidden='true'></i></a>
                                                <a href='./Comment/Delete.php?id=" . $row['id']."' 
                                                class='btn btn-red' ><i class='fa fa-trash' aria-hidden='true'></i></a>
