                ...
                <div class="painel-body">
                    <form action="#" class="form" method="post">
                        <div class="group">
                            ...
                            <input type="booktitle" class="form-control" id="booktitle" placeholder="VD: thiếu nhi, SGK..." name="booktitle">
                        </div>
...
<?php 
	...
	if (isset($_POST['submit'])) {
			...
			$queryUpdate = "insert into categorys (booktitle) VALUES ('$booktitle');";
