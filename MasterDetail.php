...
<head>
    ...
    <link href="https://cdn.datatables.net/buttons/1.7.1/css/buttons.bootstrap4.min.css" type="text/css" rel="stylesheet" />
</head>
...
EOT;
    ...
    <?php include_once(__DIR__ . '/scripts/scripts.php'); ?>
